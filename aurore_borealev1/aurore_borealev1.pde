...
PShape mol;
bore [] tabAnt = new bore[50];
Courbe [] tabCourbe = new Courbe[30];
//float [] tabposeX = {109,-26,9,80};
//float [] tabposeY = {-68,-429,113,-30};
//float [] tabposeX = {random(width),random(width),random(width),random(width),random(width),random(width),random(width),random(width),random(width),random(width)};
//float [] tabposeY = {random(height*2),random(height*2),random(height*2),random(height*2),random(height*2),random(height*2),random(height*2),random(height*2),random(height*2),random(height*2),};
...
void setup() {
  ...
  for (int j=0; j<tabCourbe.length; j++) {
    tabCourbe[j] = new Courbe(random(width), 0, random(1000), random(300), 40, random(5));
